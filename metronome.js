var Metronome=(
    function(){
        ...
        mediaDir='assets/',
        accentFile=mediaDir+'Game-Break.',
        clickFile=mediaDir+'Game-Death.',
        ...
        function preloadAudio(){
            var j,k,loaded=0,total=arguments.length-1,success;
        ...
        try{
            ...
            if(channels[0].canPlayType){
                if(channels[0].canPlayType('audio/ogg')!=='no'&&channels[0].canPlayType('audio/ogg')!==''){
                    canPlayOgg=true
                } else {
                    canPlayOgg=false
                }
                if(channels[0].canPlayType('audio/mpeg')!=='no'&&channels[0].canPlayType('audio/mpeg')!==''){
                    canPlayMp3=true
                } else {
                    canPlayMp3=false
                } if(canPlayOgg===true){
            ...
            preloadAudio(clickFile+supportedExtension,accentFile+supportedExtension,halfClickFile+supportedExtension,
                function(){
                    Metronome.start()
                }
            )
        ...
        function tempo(){
            ...
            element:null,bpm:bpm,millisecondsToBpm:millisecondsToBpm,tempo:tempo,timeDenominator:4,timeNumerator:4,sound:true,doubleTempo:false,toggleDoubleTempo:toggleDoubleTempo,click:click,start:start,stop:stop,toggle:toggle,error:null,on:false}
}());
